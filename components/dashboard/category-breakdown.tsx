        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {income.length > 0 ? income.slice(0, 5).map((category, index) => (
              ...
              <p className="text-muted-foreground text-center py-4">No income categories found</p>
            )}
            {income.length > 5 && (
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {expenditure.length > 0 ? expenditure.slice(0, 5).map((category, index) => (
              ...
              <p className="text-muted-foreground text-center py-4">No expenditure categories found</p>
            )}
